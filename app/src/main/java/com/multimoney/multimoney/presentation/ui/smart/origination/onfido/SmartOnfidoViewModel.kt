...
class SmartOnfidoViewModel @Inject constructor(
    ...
    private fun onNavigateToSignDocumentScreen(signDocumentStep: String) {
        popAndNavigateTo(
            ...
            }/$idBrand/$pkUser/$identification/$email/$idRequestSysde/$firstName/$lastName/${true}/$globalId/$user/$comingFromCrypto/${!smartSubscriptionManager.hasEvicertiaLink()}/${workflow}",
