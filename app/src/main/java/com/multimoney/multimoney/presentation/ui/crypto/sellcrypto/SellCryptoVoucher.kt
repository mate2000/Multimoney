package com.multimoney.multimoney.presentation.ui.crypto.sellcrypto
...
//                                    )
                        ...
                        Text(
                            text = stringResource(
                                R.string.sell_crypto_voucher_you_have_sold,
                                valueInCurrency,
                                currencyName
                            ),
                        ...
                        Text(
                            modifier = Modifier.fillMaxWidth(),
                            text = stringResource(
                                id = R.string.sell_crypto_voucher_value_in_dollars_template
                            ),
