...
sealed class Screen(val route: String, val baseRoute: String = "") {
    ...
    object ProfileScreen : Screen(
        "profile_screen?$ID_CLIENT={$ID_CLIENT}?$ID_BRAND={$ID_BRAND}?$FIRST_NAME={$FIRST_NAME}?$LAST_NAME={$LAST_NAME}?$EMAIL={$EMAIL}?$PHONE_NUMBER={$PHONE_NUMBER}?$IDENTIFICATION={$IDENTIFICATION}?$PK_USER={$PK_USER}?$USER_NAME={$USER_NAME}",
        "profile_screen"
    )
    ...
    object VisaIssuanceScreen : Screen(
        "visa_issuance_screen?$ID_BRAND={$ID_BRAND}?$PK_USER={$PK_USER}?$IDENTIFICATION={$IDENTIFICATION}?$EMAIL={$EMAIL}?$PHONE_NUMBER={$PHONE_NUMBER}?$BALANCE_CARD_INFORMATION={$BALANCE_CARD_INFORMATION}?$AVAILABLE_BALANCE_LABEL={$AVAILABLE_BALANCE_LABEL}?$ID_CLIENT={$ID_CLIENT}?$ID_LOAN_CLIENT={$ID_LOAN_CLIENT}",
        "visa_issuance_screen"
    )

    object VisaCardScreen : Screen(
        "visa_card_screen?$ID_BRAND={$ID_BRAND}?$PK_USER={$PK_USER}?$IDENTIFICATION={$IDENTIFICATION}?$EMAIL={$EMAIL}?$PHONE_NUMBER={$PHONE_NUMBER}?$BALANCE_CARD_INFORMATION={$BALANCE_CARD_INFORMATION}?$AVAILABLE_BALANCE_LABEL={$AVAILABLE_BALANCE_LABEL}?$ID_CLIENT={$ID_CLIENT}?$ID_LOAN_CLIENT={$ID_LOAN_CLIENT}",
        "visa_card_screen"
    )

    object VisaTokenizationWaitingScreen : Screen(
        "visa_tokenization_screen?$ID_BRAND={$ID_BRAND}?$PK_USER={$PK_USER}?$IDENTIFICATION={$IDENTIFICATION}?$EMAIL={$EMAIL}?$PHONE_NUMBER={$PHONE_NUMBER}?$BALANCE_CARD_INFORMATION={$BALANCE_CARD_INFORMATION}?$AVAILABLE_BALANCE_LABEL={$AVAILABLE_BALANCE_LABEL}?$ID_CLIENT={$ID_CLIENT}?$ID_LOAN_CLIENT={$ID_LOAN_CLIENT}?$PREVIOUS_SCREEN={$PREVIOUS_SCREEN}",
        "visa_tokenization_screen"
    )

    object VisaPreferencesScreen : Screen(
        "visa_preferences_screen?$ID_BRAND={$ID_BRAND}?$PK_USER={$PK_USER}?$IDENTIFICATION={$IDENTIFICATION}?$USER={$USER}?$PHONE_NUMBER={$PHONE_NUMBER}?$BALANCE_CARD_INFORMATION={$BALANCE_CARD_INFORMATION}?$AVAILABLE_BALANCE_LABEL={$AVAILABLE_BALANCE_LABEL}?$ID_CLIENT={$ID_CLIENT}?$ID_LOAN_CLIENT={$ID_LOAN_CLIENT}",
    ...
    object PaymentVoucherScreen : Screen(
        route = "payment_voucher_screen/{$USER}/{$ID_BRAND}/{$ID_CLIENT}/{$ID_LOAN_CLIENT}/{$CLIENT_BANK_ACCOUNT}/{$PAYMENT_DATE}/{$CURRENT_AMOUNT_VALUE}/{$PAYMENT_LABEL}/{$EXCHANGE_RATE_LABEL}/{$SHOULD_DISPLAY_EXCHANGE_RATE}/{$IS_MULTI_CURRENCY}/{$IS_AUTOMATIC_PAYMENT_CHECKED}/{$REFERENCE_NUMBER}/{$IS_AUTOPAY_ENABLED}",
        "payment_voucher_screen"
    )

    object PaymentScheduleScreen : Screen(
        "payment_schedule_screen/{$USER}/{$ID_BRAND}/{$ID_CLIENT}/{$ID_LOAN_CLIENT}/{$CLIENT_BANK_ACCOUNT}/{$PAYMENT_DATE}/{$IS_EDIT_BANK_ACCOUNT}/{$PREVIOUS_SCREEN}/{$IS_EDIT_PAYMENT_SCHEDULE}/{$IDENTIFICATION}",
