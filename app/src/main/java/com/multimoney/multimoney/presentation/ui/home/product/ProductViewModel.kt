...
import com.multimoney.multimoney.presentation.ui.home.product.ProductViewModel.UIEvent.OnNavigateToCryptoMovementScreen
...
class ProductViewModel @Inject constructor(
    ...
    private fun onNavigateToCryptoMovements(cryptoItem: BalanceCryptoAccountItems) {
        navigateTo(
            "${Screen.CryptoCurrencyMovementsScreen.baseRoute}/${uiState.idBrand}/$identification/$email/${
                encodeData(cryptoItem)
            }"
        )
    }
    ...
    fun onUIEvent(uiEvent: UIEvent) {
        when (uiEvent) {
            ...
            is OnNavigateToCryptoMovementScreen -> {
                onNavigateToCryptoMovements(uiEvent.cryptoItem)
            }
        }
    }
    ...
    sealed class UIEvent {
        ...
        data class OnNavigateToCryptoMovementScreen(val cryptoItem: BalanceCryptoAccountItems) :
            UIEvent()
