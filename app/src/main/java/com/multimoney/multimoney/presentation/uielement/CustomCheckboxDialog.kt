...
fun CustomCheckboxDialog(
    ...
    Dialog(onDismissRequest = {
        ...
        Card(
            ...
            Column(
                modifier = Modifier.padding(end = 20.dp, bottom = 18.dp),
                ...
                Column {
                    ...
                    if (title.isNotEmpty()) {
                        ...
                        Text(
                            text = title,
                            modifier.padding(top = topPaddingTitle, start = 24.dp),
                            color = titleColor,
                            style = textStyle
                        )
                    }
                    Text(
                        text = message,
                        Modifier.padding(end = 4.dp, top = topPaddingMessage, start = 24.dp),
                        color = messageColor,
