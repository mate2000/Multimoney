...
private fun ProfessionsQuery.SubOpcione.mapToDomainModel() = CreditCatalogOption(
    description = descripcion,
    pkCatalog = pk_Identificador_Catalogo,
    fkCatalog = fk_Identificador_Catalogo
)

private fun ProfessionsQuery.Profession.mapToDomainModel() = CreditCatalog(
...
fun ProfessionsQuery.Data.mapToDomainModel() = profession.map { it.mapToDomainModel() }
