...
@Composable
@Preview
fun SmartTransferAmountContent(viewModel: SavingAmountViewModel = hiltViewModel()) {
    ...
    Column(
        ...
        TopNavBar(
            ...
            onLeftButtonClick = { viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnNavigateBack) }
        )
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Column {
                ...
                CurrencyAmountInput(
                    ...
                    placeHolder = SavingAmountViewModel.SAVING_PLACEHOLDER,
                    onValueChange = {
                        viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnAmountValueChange(it.filterInvalidAmountInput()))
                    },
                ...
                Row(
                    ...
                    RoundedPaymentButton(
                        modifier = Modifier
                            .weight(0.30f),
                        onClick = { viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnSuggestedAmountClick(viewModel.uiState.minSuggestion)) },
                        strokeWidth = 1.dp,
                    ...
                    RoundedPaymentButton(
                        modifier = Modifier
                            .weight(0.30f),
                        onClick = { viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnSuggestedAmountClick(viewModel.uiState.mediumSuggestion)) },
                        strokeWidth = 1.dp,
                        roundedShapeDp = 24.dp,
                    ...
                    RoundedPaymentButton(
                        modifier = Modifier
                            .weight(0.30f),
                        onClick = { viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnSuggestedAmountClick(viewModel.uiState.maxSuggestion)) },
                        strokeWidth = 1.dp,
                        roundedShapeDp = 24.dp,
            ...
            CustomButton(
                ...
                onClick = {
                    focusManager.clearFocus()
                    viewModel.onUIEvent(SavingAmountViewModel.UIEvent.OnContinueClick)
                },
