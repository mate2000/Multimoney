...
private fun OcupationsQuery.SubOpcione.mapToDomainModel() = CreditCatalogOption(
    description = descripcion,
    pkCatalog = pk_Identificador_Catalogo,
    fkCatalog = fk_Identificador_Catalogo
)

private fun OcupationsQuery.Ocupation.mapToDomainModel() = CreditCatalog(
...
fun OcupationsQuery.Data.mapToDomainModel() = ocupation.map { it.mapToDomainModel() }
