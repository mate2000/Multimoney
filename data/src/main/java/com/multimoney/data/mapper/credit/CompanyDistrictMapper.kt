...
private fun CompanyDistrictQuery.CompanyDistrict.mapToDomainModel() = CreditCatalog(
...
private fun CompanyDistrictQuery.SubOpcione.mapToDomainModel() = CreditCatalogOption(
    description = descripcion,
    pkCatalog = pk_Identificador_Catalogo,
