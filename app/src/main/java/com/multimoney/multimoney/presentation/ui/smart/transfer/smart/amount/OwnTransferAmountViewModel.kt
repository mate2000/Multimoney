...
import com.multimoney.multimoney.presentation.ui.smart.transfer.smart.amount.OwnTransferAmountViewModel.UIEvent.OnCallProcessSinpeTransfer
...
import com.multimoney.multimoney.presentation.ui.smart.transfer.smart.amount.OwnTransferAmountViewModel.UIEvent.OnFailureWithDialog
...
import com.multimoney.multimoney.presentation.ui.smart.transfer.smart.amount.OwnTransferAmountViewModel.UIEvent.OnShareVoucherImage
...
class OwnTransferAmountViewModel @Inject constructor(
    ...
    fun onUIEvent(uiEvent: UIEvent) {
        when (uiEvent) {
            ...
            is OnMotiveChange -> onMotiveChange(uiEvent.value)
